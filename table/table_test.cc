...
TEST_F(TablePropertyTest, PrefixScanTest) {
  ...
  // prefixes that exist
  std::vector<std::string> prefixes{"num.111", "num.333", "num.555"};
  ...
  std::vector<std::string> prefixes2{"num.000", "num.222", "num.444", "num.666"};
  for (const std::string& prefix : prefixes2) {
